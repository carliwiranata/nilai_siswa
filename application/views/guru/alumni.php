...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?= base_url('guru/alumni') ?>" method="post">
                    <div class="row">
                        <div class="col-lg">
                            <div class="form-group">
                                <select class="select2-single form-control" name="id_sekolah" id="select2Single">
                                    <option value="">Pilih Sekolah</option>
                                    <?php foreach ($sekolah as $k) : ?>
                                        <option value="<?= $k['id_sekolah'] ?>" <?= set_value('id_sekolah') == $k['id_sekolah'] ? 'selected' : '' ?>><?= $k['sekolah'] ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <a href="<?= base_url('guru/alumni') ?>" class="btn btn-secondary float-right "><i class="fas fa-sync"></i></a>
                </form>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= $prakrin[0]['sekolah'] ?>" readonly class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                                </div>
                            </div>
                            <div class="col-lg">
                                <div class="form-group">
